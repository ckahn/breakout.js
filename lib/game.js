(function () {
  ...
  Game.prototype.step = function () {
    this.ball.move();
    if (this.ball.y <= 0 + this.ball.diameter) {
      this.ball.bounceY();
    } else if (this.ball.x >= Game.DIM_X - this.ball.diameter) {
      this.ball.bounceX();
    } else if (this.ball.y >= Game.DIM_Y - this.ball.diameter) {
      this.ball.bounceY();
    } else if (this.ball.x <= 0 + this.ball.diameter) {
      this.ball.bounceX();
    }
  },
